...
export function MyThoughts() {
    return (
        <div className="my-thought" id="my-thoughts">
            <h1>My Thoughts</h1>
            <div className="quotes">
                ...
                <div>Believe in deliverables rather than its results</div>
                <div>difficult roads often leasds to beautiful destinations</div>
